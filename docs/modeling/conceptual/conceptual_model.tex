...
\begin{document}
	...
	\begin{itemize}[leftmargin=1.2cm]
		...
		\item \textbf{Parcimônia:} identificadores simples são preferidos quando suficientes, recorrendo-se a composições apenas quando necessário.
	\end{itemize}
	...
	O atributo \texttt{customer\_unique\_id} será representado conceitualmente como
	\texttt{id\_cliente\_unico} e mantido como atributo de identificação
	...
	\texttt{03\_validacao\_relacionamentos.ipynb}, utilizando os arquivos originais
	...
	% ---------------------------
	\section{Construção, Refinamento e Validação do Modelo Entidade-Relacionamento}
	...
	\texttt{04\_validacao\_cardinalidades.ipynb} e com as decisões conceituais
	documentadas.
