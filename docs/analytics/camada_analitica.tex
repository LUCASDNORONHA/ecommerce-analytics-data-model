...
orientaram a fase M06 --- Camada Analítica e Extração de Inteligência.

O contrato antecedeu e orientou a implementação das consultas e
estruturas analíticas, sem transformar as issues da fase em uma sequência
...
\tightlist
\item
  M06-01 explorou a CORE a partir das perguntas priorizadas neste
  contrato;
\item
  M06-02 combinou entidades para responder aos casos de uso aprovados;
\item
  M06-03 validou a cobertura dos requisitos e registrou evidências;
\item
  M06-04 validou e consolidou o catálogo preliminar de métricas;
\item
  M06-05 persistiu somente regras reutilizáveis e semanticamente
  estáveis;
\item
  M06-06 preparou datasets com nomes, granularidade e métricas
  explícitos.
\end{itemize}
...
\item
  ...
  reutilizáveis e dos datasets de consumo nas issues M06-05 e M06-06.
\item
...
materializam dados. A etapa M06-06 definiu os campos e relacionamentos de
