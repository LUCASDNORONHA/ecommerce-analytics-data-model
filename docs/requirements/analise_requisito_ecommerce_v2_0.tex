...
\begin{itemize}
    ...
    \item \textbf{Pedido:} id\_pedido, id\_cliente, status, data\_compra, data\_aprovacao, data\_envio\_transportador, data\_entrega, data\_estimada
...
\begin{longtable}{|p{2cm}|p{12cm}|}
    ...
    RF01 & O modelo deve permitir a integração dos dados de clientes, pedidos, itens, produtos, vendedores, pagamentos, avaliações e geolocalização. \\

    RF02 & O modelo deve permitir a recuperação do histórico de pedidos e suas respectivas informações relacionadas. \\

    RF03 & O modelo deve permitir a análise de vendas segundo diferentes dimensões, incluindo período, produto, categoria, cliente, vendedor e localização geográfica. \\

    RF04 & O modelo deve permitir a análise do comportamento de compra dos clientes a partir do histórico disponível. \\

    RF05 & O modelo deve permitir a análise do desempenho comercial de produtos, categorias e vendedores. \\

    RF06 & O modelo deve permitir a análise das formas, valores e condições de pagamento associadas aos pedidos. \\

    RF07 & O modelo deve permitir relacionar avaliações dos clientes às demais informações dos respectivos pedidos. \\

    RF08 & O modelo deve permitir analisar datas previstas e efetivas associadas ao processamento e à entrega dos pedidos. \\

    RF09 & O modelo deve permitir análises geográficas utilizando informações de clientes e vendedores e, quando aplicável, coordenadas associadas aos prefixos de CEP. \\

    RF10 & O modelo deve permitir consultas que combinem múltiplas entidades sem comprometer a integridade dos relacionamentos. \\

    RF11 & O modelo deve permitir agregações e filtros por dimensões temporais, comerciais, geográficas e relacionadas aos pedidos. \\
...
\begin{longtable}{|p{2cm}|p{12cm}|}
    ...
    RNF04 & O sistema deve ser estruturado de forma a facilitar escalabilidade, manutenção e extensão. \\

    RNF05 & O sistema deve garantir padronização nos formatos de dados, especialmente datas, identificadores e atributos geográficos. \\

    RNF06 & O sistema deve assegurar a rastreabilidade das informações ao longo do fluxo de ingestão e transformação dos dados. \\
...
\begin{longtable}{|p{4cm}|p{4cm}|p{7cm}|}
    ...
    Utilizar informações consolidadas para compreender desempenho comercial, comportamento dos clientes e demais dimensões relevantes do negócio. \\

    Analistas de Dados &
    Usuários analíticos &
    Realizar consultas, análises exploratórias e diagnósticas e produzir indicadores e informações para apoio à decisão. \\

    Profissionais de BI &
    Consumidores da camada de dados &
    Utilizar dados estruturados para construção de relatórios, indicadores e dashboards. \\

    Engenharia de Dados / Administração de Banco de Dados &
    Responsáveis pela estrutura de dados &
    Assegurar qualidade, integridade, organização, desempenho e manutenção da estrutura relacional. \\
